...
description: This guide walks through integration with [HLS.js](https://github.com/video-dev/hls.js) to collect video performance metrics with Mux data.
seoTitle: Monitor HLS.js with the Mux Data SDK
seoDescription: Learn how to use the Mux Data SDK with HLS.js. Collect and measure engagement data, viewer quality of experience, and other metrics for your HLS.js video player.
steps:
  - title: Features
...
<CodeExamples product="data" example="initializeHlsjsMonitor" exampleOrder="javascript,html,react" />
