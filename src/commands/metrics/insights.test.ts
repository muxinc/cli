...
describe('mux metrics insights command', () => {
  ...
  describe('Command metadata', () => {
    test('has correct command description', () => {
      expect(insightsCommand.getDescription()).toMatch(/insight/i);
    });

    test('requires metric-id argument', () => {
      const args = insightsCommand.getArguments();
  ...
  describe('Optional flags', () => {
    test('has --measurement flag for specifying measurement type', () => {
      const measurementOption = insightsCommand
        .getOptions()
    ...
    test('has --json flag for output formatting', () => {
      const jsonOption = insightsCommand
        .getOptions()
