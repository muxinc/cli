...
describe('mux metrics overall command', () => {
  ...
  describe('Command metadata', () => {
    test('has correct command description', () => {
      expect(overallCommand.getDescription()).toMatch(/overall/i);
    });

    test('requires metric-id argument', () => {
      const args = overallCommand.getArguments();
  ...
  describe('Optional flags', () => {
    test('has --measurement flag for specifying measurement type', () => {
      const measurementOption = overallCommand
        .getOptions()
    ...
    test('has --json flag for output formatting', () => {
      const jsonOption = overallCommand
        .getOptions()
